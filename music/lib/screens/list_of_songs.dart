...
import 'package:music/config/constants/app_constants.dart';
import 'package:music/models/song.dart';
import 'package:music/player.dart';
import 'package:music/services/songsServices.dart';
import 'package:music/utils/services/api_client.dart';
import 'package:music/widgets/toast_message.dart';
...
class _ListOfSongsState extends State<ListOfSongs> {
  ...
  Icon playIcon = _icon(Icons.play_arrow, 20, const Color.fromARGB(255, 2, 38, 67));
  Icon pauseIcon = _icon(Icons.pause, 20, const Color.fromARGB(255, 2, 38, 67));
